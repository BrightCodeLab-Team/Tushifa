  ...
  return (
    <div className="new-patients main_container">
      <div className="row">
        ...
        <Link
          href="/approved-prescriptions"
          className="col-sm-6 col-xl-3 col-lg-6"
        >
            ...
            <div className="card-body">
              <div className="media text-center">
                ...
                <div className="media-body">
                  ...
                  <h3 className="mb-0 text-white">
                    {statistics?.totalApprovedPrescriptions}
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="media text-center">
                ...
                <div className="media-body">
                  ...
                  <h3 className="mb-0 text-white">
                    {statistics?.weeklySummary?.totalAmount}
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="media text-center">
                ...
                <div className="media-body">
                  ...
                  <h3 className="mb-0 text-white">
                    {statistics?.totalFulfillmentAmount}{" "}
